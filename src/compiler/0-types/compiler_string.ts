...
const method_add = new CompilerFunction('add', TYPE_NAME, ['lhs', 'rhs'], [TYPE_NAME, TYPE_NAME], ['', '']);
const method_concat = new CompilerFunction('concat', TYPE_NAME, ['lhs', 'rhs'], [TYPE_NAME, TYPE_NAME], ['', '']);
