...
export default class VMDecNumberTop extends VMInstruction {
    constructor(private _number_1:number) {
        super(1);
    }

    get_opcode(): number { return OPCODES["DECNUMTOP"]; }
    get_opname(): string { return "DECNUMTOP"; }

    get_inline_number_1() { return this._number_1; } // STEP TO DECREMENT
