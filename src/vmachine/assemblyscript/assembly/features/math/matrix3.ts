/**
 * see https://github.com/matthiasferch/tsm/blob/master/src/Matrix3.ts
 * 
 */
...
export class Matrix3 {
    ...
    equals(matrix: Matrix3, threshold = epsilon): boolean {
        for (let i = 0; i < 9; i++) {
    ...
    toQuat(): quat {
        ...
        const result = new quat(0.0, 0.0, 0.0, 0.0);
    ...
    rotate(angle: number, axis: vec3): Matrix3|undefined {
        let x = axis.x;
        let y = axis.y;
        let z = axis.z;
