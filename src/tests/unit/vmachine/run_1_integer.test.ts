...
describe('VM run test: integer operations', () => {
    ...
    it('1000 is true => 1 (instructions only)' , () => {
		const instructions:Instructions = new Instructions(undefined, 0, INSTRUCTIONS_BYTES);
		instructions.init(1, 0, 2, 25);
        instructions.i_is_true(OPCODES.LIMIT_OPD_INLINE, 1000);
        instructions.append_exit(Value.BOOLEAN);
        ...
        expect(result.type).equals(Value.BOOLEAN);
        const result_int:Boolean = <Boolean>result;
        expect(result_int.value).equals(1);
    });


    it('0 is true => 0 (instructions only)' , () => {
		const instructions:Instructions = new Instructions(undefined, 0, INSTRUCTIONS_BYTES);
		instructions.init(1, 0, 2, 25);
        instructions.i_is_true(OPCODES.LIMIT_OPD_INLINE, 0);
        instructions.append_exit(Value.BOOLEAN);
        ...
        expect(result.type).equals(Value.BOOLEAN);
        const result_int:Boolean = <Boolean>result;
        expect(result_int.value).equals(0);
    });


    it('-10 is true => 0 (instructions only)' , () => {
		const instructions:Instructions = new Instructions(undefined, 0, INSTRUCTIONS_BYTES);
		instructions.init(1, 0, 2, 25);
        instructions.i_is_true(OPCODES.LIMIT_OPD_INLINE, -10);
        instructions.append_exit(Value.BOOLEAN);
    ...
    it('1000 is positive => 1 (instructions only)' , () => {
		const instructions:Instructions = new Instructions(undefined, 0, INSTRUCTIONS_BYTES);
		instructions.init(1, 0, 2, 25);
        instructions.i_is_positive(OPCODES.LIMIT_OPD_INLINE, 1000);
        instructions.append_exit(Value.BOOLEAN);
    ...
    it('0 is positive => 0 (instructions only)' , () => {
		const instructions:Instructions = new Instructions(undefined, 0, INSTRUCTIONS_BYTES);
		instructions.init(1, 0, 2, 25);
        instructions.i_is_positive(OPCODES.LIMIT_OPD_INLINE, 0);
        instructions.append_exit(Value.BOOLEAN);
    ...
    it('-10 is positive => 0 (instructions only)' , () => {
		const instructions:Instructions = new Instructions(undefined, 0, INSTRUCTIONS_BYTES);
		instructions.init(1, 0, 2, 25);
        instructions.i_is_positive(OPCODES.LIMIT_OPD_INLINE, -10);
        instructions.append_exit(Value.BOOLEAN);
    ...
    it('1000 == 2111 => 0 (instructions only)' , () => {
		const instructions:Instructions = new Instructions(undefined, 0, INSTRUCTIONS_BYTES);
		instructions.init(1, 0, 2, 25);
        instructions.i_equal(OPCODES.LIMIT_OPD_INLINE, OPCODES.LIMIT_OPD_INLINE, 1000, 2111);    // Step 1: inline + inline
        instructions.append_exit(Value.BOOLEAN);
    ...
    it('2111 == 2111 => 0 (instructions only)' , () => {
		const instructions:Instructions = new Instructions(undefined, 0, INSTRUCTIONS_BYTES);
		instructions.init(1, 0, 2, 25);
        instructions.i_equal(OPCODES.LIMIT_OPD_INLINE, OPCODES.LIMIT_OPD_INLINE, 2111, 2111);    // Step 1: inline + inline
        instructions.append_exit(Value.BOOLEAN);
    ...
    it('1000 - 2111 => -1111 (instructions only)' , () => {
		const instructions:Instructions = new Instructions(undefined, 0, INSTRUCTIONS_BYTES);
		instructions.init(1, 0, 2, 25);
        instructions.i_sub(OPCODES.LIMIT_OPD_INLINE, OPCODES.LIMIT_OPD_INLINE, 1000, 2111);    // Step 1: inline + inline
        instructions.append_exit(Value.INTEGER);
        ...
        expect(result.type).equals(Value.INTEGER);
        const result_int:Integer = <Integer>result;
        expect(result_int.value).equals(-1111);
    });


    it('3000 / 100 => 30 (instructions only)' , () => {
		const instructions:Instructions = new Instructions(undefined, 0, INSTRUCTIONS_BYTES);
		instructions.init(1, 0, 2, 25);
        instructions.i_div(OPCODES.LIMIT_OPD_INLINE, 100, 3000);    // Step 1: inline / inline
        instructions.append_exit(Value.INTEGER);
        ...
        expect(result.type).equals(Value.INTEGER);
        const result_int:Integer = <Integer>result;
        expect(result_int.value).equals(30);
    });


    it('3000 * 100 => 30000 (instructions only)' , () => {
		const instructions:Instructions = new Instructions(undefined, 0, INSTRUCTIONS_BYTES);
		instructions.init(1, 0, 2, 25);
        instructions.i_mul(OPCODES.LIMIT_OPD_INLINE, 100, 3000);    // Step 1: inline * inline
        instructions.append_exit(Value.INTEGER);
        ...
        expect(result.type).equals(Value.INTEGER);
        const result_int:Integer = <Integer>result;
        expect(result_int.value).equals(300000);
    });


    it('30 ^ 2 => 900 (instructions only)' , () => {
		const instructions:Instructions = new Instructions(undefined, 0, INSTRUCTIONS_BYTES);
		instructions.init(1, 0, 2, 25);
        instructions.i_pow(30, 2);    // Step 1: inline ^ inline
        instructions.append_exit(Value.INTEGER);
        ...
        expect(result.type).equals(Value.INTEGER);
        const result_int:Integer = <Integer>result;
        expect(result_int.value).equals(900);
    });
...
*/
    it('4411000 / ( 33 - (782154115 + 45) ) => -1 (instructions and registers)' , () => {
		const instructions:Instructions = new Instructions(undefined, 0, INSTRUCTIONS_BYTES);
		instructions.init(1, 0, 2, 25);
    ...
    it('if ( 33 - (782154115 + 45) ) > 0 then 1 else 2 => 2 (instructions and registers)' , () => {
        ...
        instructions.append_instruction_i32(OPCODES.JUMP_IF_TRUE, Value.INTEGER, OPCODES.LIMIT_OPD_STACK, OPCODES.LIMIT_OPD_INLINE, 44); // Step 4: if true jump to 44
        instructions.push_value(Value.INTEGER, 2);                                       // Step False
        instructions.append_exit(Value.INTEGER);                                         // Exit
        instructions.push_value(Value.INTEGER, 1);                                       // Step True
        instructions.append_exit(Value.INTEGER);                                         // Exit
        ...
        expect(result.type).equals(Value.INTEGER);
        const result_int:Integer = <Integer>result;
        expect(result_int.value).equals(2);
    });
});